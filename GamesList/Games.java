    ...
    public int YoTengo() {
        ...
        while (coins > 0) {
            if (Helper.tools.getRandomNumber(1,20) == 1) {
                System.out.println(Helper.tools.getRandomFrom(AztexGodsForYes) + "decides to smite you. \nBye Bye coins (You lose half your coins).\n");
                coins /= 2;
            }
            else if (Helper.tools.getRandomNumber(1,20) == 1) {
                System.out.println(Helper.tools.getRandomFrom(AztexGodsForNo) + "takes pity on you.\n Be thankful (You double your coins).\n");
                coins *= 2;
            }
            ...
            while (tooManyNos) {
                ...
                if (Helper.tools.getRandomNumber(1,10) == 1) {
                    System.out.println();
                    System.out.println(Helper.tools.getRandomFrom(AztexGodsForYes) + " fills you with the need to risk it. \nYou accept this deal despite your best judgment.");
                    ...
                    System.out.println();
                    System.out.println(Helper.tools.getRandomFrom(AztexGodsForNo) + " protects you from that stupid need to bet. \nYou reject this deal despite your best judgment.");
                    Helper.tools.waiting(1500);
                    input = "n";
                    ForGodsSake = true;
                    Helper.tools.getString("Click enter to continue ");
                ...
                if (input.equals("n")) {
                    ...
                    System.out.println(round < (6-difficulty));
                    if (NoCheck) {
